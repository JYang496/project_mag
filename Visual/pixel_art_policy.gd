...
const WEAPON_MODULE_STANDARD_SIZE := Vector2i(40, 56)
const WEAPON_MODULE_LONG_SIZE := Vector2i(40, 64)
const WEAPON_MODULE_HEAVY_SIZE := Vector2i(48, 56)
const WEAPON_MODULE_PADDING_PX := 4

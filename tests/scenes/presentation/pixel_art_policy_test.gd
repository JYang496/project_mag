...
func _run() -> void:
	...
	_test_player_animation_frames()
	_test_exact_asset_sizes()
	_test_runtime_visual_grain()
	_test_modern_ui_contract()
	_test_cell_presentation_policy()
	_test_all_module_icons()
	if _failed:
		print("FAIL: pixel art policy")
	else:
		print("PASS: pixel art policy")

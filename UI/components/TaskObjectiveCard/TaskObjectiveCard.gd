...
func _set_marker(key: String, state: String) -> void:
	...
	var style := (marker.get_theme_stylebox("normal") as StyleBoxFlat).duplicate() as StyleBoxFlat
...
func _set_state(state: String) -> void:
	...
	var fill_style := (progress_bar.get_theme_stylebox("fill") as StyleBoxFlat).duplicate() as StyleBoxFlat

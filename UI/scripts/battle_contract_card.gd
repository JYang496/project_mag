...
func setup(value: BattleContractDefinition) -> void:
	...
	$Margin/Content/Description.visible = not is_reward
	$Margin/Content/Reward.visible = not is_reward
	...
	if id == "reward":
		...
		$Margin/Content/Description.text = "%s\n%s" % [objective_label, objective]
		$Margin/Content/Reward.text = "%s\n%s" % [reward_label, reward_hint]
...
func show_battle_intro(objective: String, parameters_text: String) -> void:
	...
	$Margin/Content/Description.visible = true
	$Margin/Content/Description.text = objective
	$Margin/Content/Description.add_theme_font_size_override("font_size", 20)
	$Margin/Content/Reward.visible = true
	$Margin/Content/Reward.text = parameters_text
	$Margin/Content/Reward.add_theme_font_size_override("font_size", 16)
	$Margin/Content/Reward.add_theme_color_override("font_color", _accent_color)
...
func _apply_card_styles() -> void:
	...
	$Margin/Content/Description.add_theme_color_override("font_color", Color(0.82, 0.89, 0.91))
	$Margin/Content/Reward.add_theme_color_override("font_color", Color(1.0, 0.82, 0.38) if _contract_id == "reward" else Color(0.65, 0.74, 0.77))

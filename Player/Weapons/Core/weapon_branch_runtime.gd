...
func get_empowered_attack_passive_id() -> StringName:
	for behavior in get_branch_behaviors():
		var passive_id := behavior.get_empowered_attack_passive_id()
...
func get_empowered_attack_display_name() -> String:
	for behavior in get_branch_behaviors():
		var display_name := behavior.get_empowered_attack_display_name()
...
func get_empowered_attack_bonus() -> float:
	for behavior in get_branch_behaviors():
		var value := behavior.get_empowered_attack_bonus()
		if value >= 0.0:
			return value
	return -1.0
